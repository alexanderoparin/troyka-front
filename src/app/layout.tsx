...
export const metadata: Metadata = {
  ...
  description: 'Создавайте профессиональные изображения товаров с помощью искусственного интеллекта. Получите +4 поинта при регистрации! Подтвердите email для доступа ко всем функциям.',
